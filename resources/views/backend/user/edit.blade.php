    ...
    <div class="col-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body pt-0 pb-2">
                ...
                <form class="form-style form-v" action="{{ route('users.update', [$user->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="phone" name="phone" class="form-control" id="phone" data-v-min-length="7" data-v-max-length="13" value="{{ $user->phone }}" required>
                    </div>
                    <div class="mb-3">
