...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="ps ps--active-y w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ url()->current() == route('admin.dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ url()->current() == route('instructor.index') ? 'active' : '' }}" href="{{ route('instructor.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
