                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navigation">
                            ...
                            <ul class="navbar-nav d-lg-block d-none">
                                <li class="nav-item">
                                    <a href="#" class="btn btn-sm mb-0 me-1 btn-primary">Contact</a>
                                </li>
                            </ul>
                        </div>
                    </div>
  ...
  <main class="main-content mt-7">
    <section>
      <div class="page-header min-vh-100">
        <div class="container">
            <div class="row">
                <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute start-0 top-0 text-center justify-content-center flex-column">
                ...
                <div class="col-xl-4 col-lg-5 col-md-7 d-flex position-absolute end-0 top-10 mt-6 mx-7 flex-column ">
                    <div class="card card-plain">
                        <div class="card-header pb-0 text-start">
                            <h4 class="font-weight-bolder">Admin Log In</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.login') }}" method="POST">
                                ...
                                <div class="form-check d-flex justify-content-between form-switch">
                                    <div>
                                        <input class="form-check-input" name="remember" type="checkbox" id="rememberMe">
                                        <label class="form-check-label" for="rememberMe">Remember me</label>
                                    </div>
                                    <div>
                                        <a href="{{ route('admin.getForgot') }}" class="nav-link me-2"><p class="form-check-label">Forget Password?</p></a>
                                    </div>
                                </div>
...
@if (session()->has('reset_success'))
    <script>
        ...
        notifier.success("{{ session('reset_success') }}", {durations: {info: 3000}})
    </script>
@endif
</body>
