                ...
                <div class="col-lg-5 col-md-8 py-8 py-xl-0">
                    ...
                    <div class="card shadow card-bg">
                        ...
                        <div class="card-body p-6">
                            <div class="mb-4">
                                <p class=" head-icon"><i class="ri-lock-unlock-fill fs-1"></i></p>
                                <h3 class="mb-1 fw-bold">Reset Password</h1>
                                <p>Fill the form to update your password.</p>
                            </div>
                            ...
                            <form action="{{ route('admin.resetPassword') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" id="confirm-password" class="form-control" name="password_confirmation" placeholder="Retype Password "
                                        required />
                                </div>
